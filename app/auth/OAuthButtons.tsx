...
export const OAuthButtons = () => {
  ...
  return <div className="space-y-3">
      ...
      <button onClick={signInWithGitHub} className="w-full flex items-center justify-center space-x-3 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors" type="button">
        <svg className="w-5 h-5" viewBox="0 0 24 24">

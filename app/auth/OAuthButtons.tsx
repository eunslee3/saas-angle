...
export const OAuthButtons = () => {
  const signInWithGoogle = async () => {
    console.log('Log before supabase.auth.signInWithOAuth')
  ...
  return <div className="space-y-3">
      ...
      <button className="w-full flex items-center justify-center space-x-3 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors" type="button">
        <svg className="w-5 h-5" viewBox="0 0 24 24">
